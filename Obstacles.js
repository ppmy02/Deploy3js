...
class Obstacles{
	...
	update(pos){
        ...
        this.obstacles.forEach( obstacle =>{
            obstacle.children[0].rotateY(0.1);
            const relativePosZ = obstacle.position.z-pos.z;
            if (Math.abs(relativePosZ)<1 && !obstacle.userData.hit){
